...
type TemplateString struct {
	...
	DefaultDurability int32                  `protobuf:"varint,4,opt,name=default_durability,json=defaultDurability,proto3" json:"default_durability,omitempty"`
	Type              StringType             `protobuf:"varint,5,opt,name=type,proto3,enum=string_phone.strings.resources.StringType" json:"type,omitempty"`
...
func (x *TemplateString) GetLength() int32 {
	if x != nil {
		return x.Length
	}
	return 0
...
const file_string_phone_strings_resources_string_proto_rawDesc = "" +
	"\n" +
	"+string_phone/strings/resources/string.proto\x12\x1estring_phone.strings.resources\x1a\x1fgoogle/protobuf/timestamp.proto\"\xbb\x01\n" +
	"\x0eTemplateString\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12\x16\n" +
	"\x06length\x18\x03 \x01(\x05R\x06length\x12-\n" +
	"\x12default_durability\x18\x04 \x01(\x05R\x11defaultDurability\x12>\n" +
	"\x04type\x18\x05 \x01(\x0e2*.string_phone.strings.resources.StringTypeR\x04type\"\x9a\x02\n" +
	"\x06String\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12\x16\n" +
